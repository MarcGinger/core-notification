...
/**
 * Event emitted when a transaction processing has failed
 */
export class TransactionFailedEvent extends TransactionDomainEvent {
  readonly eventType = 'transaction.failed.v1';
