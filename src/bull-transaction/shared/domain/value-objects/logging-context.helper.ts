...
import { BullTransactionServiceConstants } from './service-constants';
 ...
 */
export class BullTransactionLoggingHelper {
  /**
  ...
  static createEnhancedLogContext(
    ...
    const baseContext = BullTransactionServiceConstants.getLoggingContext(
      component,
      method,
      identifier,
    );
