...
import { CoreSlackWorkerServiceConstants } from './service-constants';
 ...
 */
export class CoreSlackWorkerLoggingHelper {
  /**
  ...
  static createEnhancedLogContext(
    ...
    const baseContext = CoreSlackWorkerServiceConstants.getLoggingContext(
      component,
      method,
      identifier,
    );
