...
export const MessageExceptionMessage: Record<string, IException> = {
  ...
  fieldCreatedAtRequired: {
    message: `Created at is required`,
    description: `The created_at field is required for Message`,
    code: `INVALID_CREATED_AT_VALUE`,
    exception: `MessageDomainException`,
    statusCode: `400`,
    domain: `true`,
  },
  fieldUpdatedAtRequired: {
    message: `Updated at is required`,
    description: `The updated_at field is required for Message`,
    code: `INVALID_UPDATED_AT_VALUE`,
    exception: `MessageDomainException`,
    statusCode: `400`,
    domain: `true`,
  },
  ...
  requiredCreatedAt: {
    message: `CreatedAt is required and cannot be null or undefined`,
    description: `This error occurs when validating a Message and the required field createdAt is missing or null.`,
    code: `REQUIRED_CREATED_AT_FOR_MESSAGE`,
    exception: `MessageDomainException`,
    statusCode: `400`,
    domain: `true`,
  },
  requiredUpdatedAt: {
    message: `UpdatedAt is required and cannot be null or undefined`,
    description: `This error occurs when validating a Message and the required field updatedAt is missing or null.`,
    code: `REQUIRED_UPDATED_AT_FOR_MESSAGE`,
    exception: `MessageDomainException`,
    statusCode: `400`,
    domain: `true`,
  },
