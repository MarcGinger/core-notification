...
import { CoreSlackWorkerServiceConstants } from '../../../shared/domain/value-objects';
 ...
 */
export class MessageProjectionKeys {
  // EventStore DB patterns
  static readonly ESDB_BOUNDED_CONTEXT =
    CoreSlackWorkerServiceConstants.BOUNDED_CONTEXT;
