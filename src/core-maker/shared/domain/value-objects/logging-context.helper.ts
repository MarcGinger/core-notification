...
import { CoreMakerServiceConstants } from './service-constants';
 ...
 */
export class CoreMakerLoggingHelper {
  /**
  ...
  static createEnhancedLogContext(
    ...
    const baseContext = CoreMakerServiceConstants.getLoggingContext(
      component,
      method,
      identifier,
    );
