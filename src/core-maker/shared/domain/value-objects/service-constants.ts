...
/**
 * Service-wide constants for the core object maker bounded context
 *
 * This value object encapsulates fundamental domain concepts that are
 * consistent across all aggregates within the core-maker service.
 *
 * Domain Context: Cross-cutting domain constants
 * Bounded Context: core-maker Module
 */
export class CoreMakerServiceConstants {
  /**
   * Service identifier for the core-maker bounded context
   * Used in event metadata, logging, and service identification
   */
  static readonly SERVICE_NAME = 'core-maker' as const;
   ...
   */
  static readonly BOUNDED_CONTEXT = 'coreMaker' as const;
