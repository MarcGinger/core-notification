...
/**
 * Service-wide constants for the core slack management bounded context
 *
 * This value object encapsulates fundamental domain concepts that are
 * consistent across all aggregates within the core-template-manager service.
 *
 * Domain Context: Cross-cutting domain constants
 * Bounded Context: core-template-manager Module
 */
export class CoreTemplateManagerServiceConstants {
  /**
   * Service identifier for the core-template-manager bounded context
   * Used in event metadata, logging, and service identification
   */
  static readonly SERVICE_NAME = 'core-template-manager' as const;
   ...
   */
  static readonly BOUNDED_CONTEXT = 'coreTemplateManager' as const;
