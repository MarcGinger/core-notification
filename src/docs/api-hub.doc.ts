...
## Bounded Context - Slack
  ...
  | Documentation | Description | Link |
  |---------------|-------------|------|
  | **Core slack worker** | This is the core slack messaging service | [📖 View Docs](/api/docs/core-slack-worker) |
  | **Core slack management** | This is the core slack messaging service | [📖 View Docs](/api/docs/core-template-manager) |
